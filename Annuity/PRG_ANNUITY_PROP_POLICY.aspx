<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_ANNUITY_PROP_POLICY.aspx.vb" Inherits="Annuity_PRG_LI_PROP_POLICY" %>
...
<body style="background-color: White;">
    ...
    <div id="div_header" align="center">
            <asp:Panel ID="menuPanel" CssClass="menuPanel" runat="server">&nbsp;&nbsp;
                &nbsp;<asp:LinkButton ID="LNK_QUOTE" Enabled="true" Font-Bold="true" runat="server" Text="Proposal Entry" PostBackUrl="PRG_ANNUITY_PROP_POLICY.aspx?menu=IL_QUOTE"></asp:LinkButton>&nbsp;
