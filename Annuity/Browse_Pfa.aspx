<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Browse_Pfa.aspx.vb" Inherits="Annuity_Browse_Pfa" %>
            ...
            <tr>
                <td align="center" valign="top" colspan="4" style=" height:600px; width: 1000px;">
                    <table align="center" border="0">
                        ...
                        <tr>
                            <td align="left" valign="top">PFA CODE</td>
                            <td align="left" valign="top">PFA NAME</td>
                            <td align="left" valign="top" colspan="2">PFA SHORT DESC.</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="left" colspan="4" valign="top">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                    ...
                                    DataKeyNames="TBIL_PFA_REC_ID" HorizontalAlign="Left" PageSize="10"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TBIL_PFA_CODE" HeaderText="PFA CODE" HeaderStyle-HorizontalAlign="Left" 
                                            ReadOnly="True">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="TBIL_PFA_DESC" HeaderText="PFA NAME" HeaderStyle-HorizontalAlign="Left" 
                                            ReadOnly="True">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="TBIL_PFA_SHRT_DESC" HeaderText="SHORT DESC" HeaderStyle-HorizontalAlign="Left"
                                            ReadOnly="true" >
                                        </asp:BoundField>
                                    </Columns>
