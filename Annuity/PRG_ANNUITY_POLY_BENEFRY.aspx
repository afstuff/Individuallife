<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_ANNUITY_POLY_BENEFRY.aspx.vb" Inherits="Annuity_PRG_ANNUITY_POLY_BENEFRY" %>
                ...
                <tr>
                    <td align="center" valign="top" class="td_menu">
                        <table align="center" border="0" class="tbl_menu_new">
                            ...
                            <tr>
                                                <td nowrap align="right" valign="top"><asp:Label ID="lblProduct" Enabled="true" Text="Product Category/Code:" runat="server"></asp:Label></td>
                            ...
                            <tr>
                                <td colspan="4">
                                    <table align="center" border="1" style="width: 100%">
                                        <tr>
                                                <td nowrap align="right" valign="top"><asp:Label ID="lblBenef_Cover_ID" Enabled="false" Text="Select Member:" runat="server"></asp:Label></td>
                                        ...
                                        <tr class="tr_frame">
                                            ...
                                            <td align="left" valign="top"><asp:Label ID="lblBenef_Type" Text="Type of Beneficiary" runat="server"></asp:Label></td>
                                            <td align="left" valign="top"><asp:Label ID="lblBenef_Category" Text="Beneficiary Category" runat="server"></asp:Label></td>
                                            <td align="left" valign="top" colspan="1"><asp:Label ID="lblBenef_Name" Text="Beneficiary Name" runat="server"></asp:Label></td>
                                            <td align="left" valign="top"><asp:Label ID="lblBenef_Percentage" Text="Percentage" ToolTip="" runat="server"></asp:Label></td>
                                        </tr>
                                        <tr style="font-size: small;">
                                            ...
                                            <td align="left" valign="top"><asp:TextBox ID="txtBenef_Percentage" MaxLength="6" Width="40px" ToolTip="" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr class="tr_frame">
                                            <td align="left" valign="top"><asp:Label ID="lblBenef_DOB" Text="Date of Birth / Age" ToolTip="Date of Birth(dd/mm/yyyy)" runat="server"></asp:Label></td>
                                            <td align="left" valign="top"><asp:Label ID="lblBenef_Relationship" Text="Relationship" ToolTip="" runat="server"></asp:Label></td>
                                            <td align="left" valign="top"><asp:Label ID="lblBenef_Address" Text="Beneficiary Address" ToolTip="" runat="server"></asp:Label></td>
                                            <td align="left" valign="top" colspan="2"><asp:Label ID="lblBenef_GuardianName" Text="Guardian Name" ToolTip="" runat="server"></asp:Label></td>
                                        </tr>
                                        <tr style="font-size: small;">
                                            <td align="left" valign="top"><asp:TextBox ID="txtBenef_DOB" MaxLength="10" Width="100px" ToolTip="Date of Birth(dd/mm/yyyy)" runat="server"></asp:TextBox>
                                            ...
                                            <td align="left" valign="top"><asp:TextBox ID="txtBenef_Address" MaxLength="95" ToolTip="" runat="server" Width="200px"></asp:TextBox></td>
                                            <td align="left" valign="top" colspan="2"><asp:TextBox ID="txtBenef_GuardianName" MaxLength="49" ToolTip="" runat="server" Width="200px"></asp:TextBox></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
