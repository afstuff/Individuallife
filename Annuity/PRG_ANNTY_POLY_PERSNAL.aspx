<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_ANNTY_POLY_PERSNAL.aspx.vb" Inherits="Annuity_PRG_ANNTY_POLY_PERSNAL" %>
                    ...
                    <td align="center" valign="top" class="td_menu">
                        <table align="center" border="0" class="tbl_menu_new">
                            ...
                            <tr>
                                    ...
                                    <tr>
                                                <td align="left" valign="top"><asp:Label ID="Label1" Text="Last Employer:" runat="server"></asp:Label></td>
                                                ...
                                                <td align="left" valign="top"><asp:Label ID="Label3" Text="Last Emp. Addr:" runat="server"></asp:Label></td>
                                                <td>
                                                    <asp:TextBox ID="txtLastEmpAddr" Visible="true" Enabled="true"  Width="300px" runat="server"></asp:TextBox>
                                                </td>
                                    </tr>
                                    <tr>
                                                <td align="left" valign="top"><asp:Label ID="Label4" Text="PFA:" runat="server"></asp:Label></td>
                                                <td align="left" valign="top" colspan="0">
                                                    <asp:TextBox ID="txtPFA" Visible="true" Enabled="true"  Width="250px" runat="server"></asp:TextBox>
                                                </td>    
                                                <td align="left" valign="top"><asp:Label ID="Label5" Text="PIN Number:" runat="server"></asp:Label></td>
                                                <td>
                                                    <asp:TextBox ID="txtPIN" Visible="true" Enabled="true"  Width="300px" runat="server"></asp:TextBox>
                                                </td>
                                    </tr>
                                    <tr>
                                                <td align="left" valign="top"><asp:Label ID="Label6" Text="Last Occupation:" runat="server"></asp:Label></td>
                                                <td align="left" valign="top" colspan="0">
                                                    <asp:TextBox ID="txtLastOccupation" Visible="true" Enabled="true"  Width="250px" runat="server"></asp:TextBox>
                                                </td>    
                                                <td align="left" valign="top"><asp:Label ID="Label7" Text="Bank Name:" runat="server"></asp:Label></td>
                                                <td>
                                                    <asp:TextBox ID="txtBankName" Visible="true" Enabled="true"  Width="300px" runat="server"></asp:TextBox>
                                                </td>
                                    </tr>
                                    <tr>
                                                <td align="left" valign="top"><asp:Label ID="Label8" Text="Bank A/C Name:" runat="server"></asp:Label></td>
                                                <td align="left" valign="top" colspan="0">
                                                    <asp:TextBox ID="txtAccountName" Visible="true" Enabled="true"  Width="250px" runat="server"></asp:TextBox>
                                                </td>    
                                                <td align="left" valign="top"><asp:Label ID="Label9" Text="Account No:" runat="server"></asp:Label></td>
                                                <td>
                                    ...
                                    <tr>
                                                <td align="left" valign="top"><asp:Label ID="Label10" Text="Bank Ssort Code:" runat="server"></asp:Label></td>
                                                <td align="left" valign="top" colspan="0">
                                                    <asp:TextBox ID="txtBankSortCode" Visible="true" Enabled="true"  Width="250px" runat="server"></asp:TextBox>
                                                </td>    
                                                <td align="left" valign="top"><asp:Label ID="Label11" Text="Bank Address:" runat="server"></asp:Label></td>
                                                <td>
                                    ...
                                    <tr>
                                                <td align="left" valign="top"><asp:Label ID="Label2" Text="Other Reference No:" runat="server"></asp:Label></td>
                                                <td align="left" valign="top" colspan="1">
