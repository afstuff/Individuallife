<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_ASSOCIATE_COY.aspx.vb"
    Inherits="I_LIFE_PRG_LI_ASSOCIATE_COY" %>
            ...
            <tr>
                <td align="center" colspan="4" class="tbl_buttons">
                    <table align="left" border="0" width="100%">
                        <tr>
                            <td align="left" colspan="" valign="baseline">
                            ...
                            <td align="left" colspan="" valign="baseline">
                                ...
                                <input type="text" id="txtSearch" name="txtSearch" value="Search..." runat="server"
                                  Width="140px"  onfocus="if (this.value == 'Search...') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Search...';}"></input>&nbsp;
                    ...
                    <table align="center" border="0" cellpadding="1" cellspacing="1" class="tbl_menu_new">
                        <tr>
                            <td align="left" colspan="4" class="myMenu_Title">
                                <%=STRPAGE_TITLE%>
                                <asp:Label ID="Label1" runat="server" Text="+++ ASSOCIATE COMPANIES DATA ENTRY +++"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <td align="left" colspan="4" valign="top">
                                            <asp:GridView ID="GridView1" CellPadding="2" runat="server" CssClass="grd_ctrl" DataKeyNames="TBGL_REC_ID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField ReadOnly="true" DataField="TBGL_CODE" HeaderText="Ass. Code" HeaderStyle-HorizontalAlign="Left"
                                                        ConvertEmptyStringToNull="true" />
                                                    <asp:BoundField ReadOnly="true" DataField="TBGL_FULL_NAME" HeaderText="Ass. Name"
                        ...
                        <tr>
                            <td align="right" nowrap>
                                <asp:Label ID="lblTBGL_BRANCH6" Enabled="False" Text="Contact Name:" 
                                    runat="server"></asp:Label>
                            </td>
                            <td align="left" nowrap>
                                <asp:TextBox ID="txtTBGL_PERSON_RESP" runat="server" Width="250px"></asp:TextBox>
                            </td>
