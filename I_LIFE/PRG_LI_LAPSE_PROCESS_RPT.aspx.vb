...
Partial Class I_LIFE_PRG_LI_LAPSE_PROCESS_RPT
    ...
    Protected Sub butOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles butOK.Click
        ...
        Dim startDate As Date = CDate(DoConvertToDbDateFormat(txtStartDate.Text))
        Dim endDate As Date = CDate(DoConvertToDbDateFormat(txtEndDate.Text))
    ...
    Protected Sub butClose_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles butClose.Click
        Response.Redirect("PRG_LI_LAPSE_PROCESS.aspx")
    End Sub
End Class
