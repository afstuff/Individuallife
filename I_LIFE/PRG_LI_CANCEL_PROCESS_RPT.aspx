<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_CANCEL_PROCESS_RPT.aspx.vb" Inherits="I_LIFE_PRG_LI_CANCEL_PROCESS_RPT" %>
...
<body>
    <form id="PRG_LI_CANCEL_PROCESS_RPT" runat="server">
      <div>
    </div>
    <div  class="newpage">
    <table>
     ...
     <div class="grid">
            <div class="rounded">
                <div class="top-outer"><div class="top-inner"><div class="top">
                    <h2>PRINT: Policy Cancellation Report Listing</h2>
                </div></div></div>
                ...
                <table class="tbl_menu_new">
				    ...
				    <tr>
					    <td>Cancellation Start Date</td>
					    <td><asp:TextBox ID="txtStartDate" runat="server" Width="150px" MaxLength=10 ></asp:TextBox>
					    				<script language="JavaScript" type="text/javascript">
					    				    new tcal({ 'formname': 'PRG_LI_CANCEL_PROCESS_RPT', 'controlname': 'txtStartDate' });</script>dd/mm/yyyy</td>
				    </tr>
    				
				    
				    <tr>
					    <td>Cancellation End Date</td>
					    <td><asp:TextBox ID="txtEndDate" runat="server" Width="150px" MaxLength=10 ></asp:TextBox> <script language="JavaScript" type="text/javascript">
                                 new tcal({ 'formname': 'PRG_LI_CANCEL_PROCESS_RPT', 'controlname': 'txtEndDate' });</script>dd/mm/yyyy
					    					</td>
				    </tr>
