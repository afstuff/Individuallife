<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PRG_LI_INDV_POLY_MEDIC_INFO.aspx.vb" Inherits="I_LIFE_PRG_LI_INDV_POLY_MEDIC_INFO" %>
...
<body onload="<%= FirstMsg %>">
    ...
    <div id="div_content" align="center">
        <table class="tbl_cont" align="center">
                <tr>
                    <td nowrap class="myheader">Medical Examination Information</td>
                </tr>
                <tr>
