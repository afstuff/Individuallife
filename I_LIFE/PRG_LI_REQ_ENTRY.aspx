                    ...
                    <table align="center" border="0" class="tbl_menu_new">
                        ...
                        <tr>
                            <td align="left" valign="top" class="style1">
                                ...
                                <asp:Label ID="lblFileNum" Text="Claim #:" runat="server" Visible="False"></asp:Label>
                            </td>
                            ...
                            <td align="left" valign="top" class="style3">
                                ...
                                <asp:Label ID="lblPolyNum" Text="Policy #:" runat="server" Visible="False"></asp:Label>
                            </td>
                            <td align="left" valign="top" class="style2">
                                <asp:TextBox ID="txtPolicyNumber" runat="server" Enabled="False"></asp:TextBox>
                                <asp:Button ID="cmdPolyNoGet" Enabled="false" Text="Get Record" runat="server" />
                                <asp:TextBox ID="txtRecNo0" Visible="false" Enabled="false" MaxLength="18" Width="40"
                                    runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top" class="style2">
                                <asp:TextBox ID="txtBasicSumClaimsLC" runat="server"></asp:TextBox>
                            </td>
                            <td align="left" valign="top" class="style3">
                                <asp:Label ID="Label8" runat="server" Text="Basic Sum Claimed FC:"></asp:Label>
                            </td>
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtBasicSumClaimsFC" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" class="style1">
                            ...
                            <td align="left" valign="top" class="style2">
                                <asp:TextBox ID="txtAdditionalSumClaimsLC" runat="server"></asp:TextBox>
                            </td>
                            <td align="left" valign="top" class="style3">
                                <asp:Label ID="Label10" runat="server" Text="Add. Sum Claimed FC:"></asp:Label>
                            </td>
                            <td align="left" valign="top" class="style2">
                                <asp:TextBox ID="txtAdditionalSumClaimsFC" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" class="style1">
                            ...
                            <td align="left" valign="top" class="style2">
                                <asp:TextBox ID="txtAssuredAge" runat="server"></asp:TextBox>
                            </td>
                            <td align="left" valign="top" class="style3">
                                <asp:Label ID="Label12" runat="server" Text="System Module:"></asp:Label>
                            </td>
                            <td align="left" valign="top" class="style2">
                                <asp:DropDownList ID="DdnSysModule" runat="server">
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top" class="style2">
                                <asp:DropDownList ID="DdnClaimType" runat="server">
                                    <asp:ListItem Value="0">--- Select ---</asp:ListItem>
